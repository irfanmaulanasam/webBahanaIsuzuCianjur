...
// Asumsi: Import useNavigate dari pustaka router Anda (misal: React Router)
import { useNavigate } from 'react-router-dom'; 

export default function ProductsGrid({ data = productsSummary }) {
  // state for category filter
  const [category, setCategory] = useState("ALL");
  // Hapus 'active' state karena kita tidak lagi menggunakan modal
  ...
  return (
    <div className="px-4 py-8">
      ...
      {/* HAPUS SEMUA LOGIKA MODAL (active state dan Modal component di sini) */}
      {/* Jika Anda perlu Modal, Anda harus mengimplementasikannya di halaman /spec/:slug */}
